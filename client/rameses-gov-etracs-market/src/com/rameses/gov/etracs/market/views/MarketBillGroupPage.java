...
public class MarketBillGroupPage extends javax.swing.JPanel {

    /**
     * Creates new form BlockSchedulePage
     */
    public MarketBillGroupPage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        xComboBox1.setCaption("Payment Mode");
        xComboBox1.setDisableWhen("#{ mode != 'create' }");
        xComboBox1.setItems("paymentModes");
        ...
        schemaList2.setCustomFilter("billgroupid = :objid");
        schemaList2.setFormActions("scheduleActions");
        schemaList2.setHandler("scheduleList");
        schemaList2.setOrderBy("year DESC, month DESC");
        schemaList2.setQueryName("entity");
        schemaList2.setSchemaName("market_bill_schedule");
        schemaList2.setAllowDelete(true);
        xPanel1.add(schemaList2, java.awt.BorderLayout.CENTER);

        xTabbedPane1.addTab("Billing Schedule", xPanel1);
